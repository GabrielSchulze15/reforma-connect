...
import { getIdToken, signInWithPopup, signInWithEmailAndPassword, sendPasswordResetEmail } from "firebase/auth";
...
async function redirecionarPorTipo(uid: string) {
  ...
  className="text-right text-orange-500 text-sm mb-6 cursor-pointer"
>
  Esqueceu sua senha?
</p>

{mostrarReset && (
  <div className="bg-orange-50 border border-orange-200 rounded-2xl px-4 py-4 mb-4 flex flex-col gap-3">
    {resetEnviado ? (
